...
#define CPUID_SIGNATURE		0x01
#define CPUID_GETFEATURES	0x101
#define CPUID_APICID		0x102

//different vendor strings defined
...
extern int gettick();
extern void init_pit(uint freq);

extern void wait(uint ms);
extern void init_rtc();

extern void kbd_get_string(char *buffer);
